...
# Scores de base
Scores de base : 2 dans chaque aspect, 1 dans chaque caractéristique.

# Archétypes
Servent à poser l'idée du personnage.

Cet archétype reflète son **passé** avant le Knight.

Étoffez le lore de votre personnage quand vous choisissez un archétype !

Les factions (rebuts, Nodachi...) sont expliquées dans [[Le monde d'aujourd'hui]] ou [[Contexte historique]].

Ils sont également listés [ici](https://www.knight-jdr-systeme.fr/fr/archetype/).

| Archétype                       | Lore                                               | Bonus                               |
| ------------------------------- | -------------------------------------------------- | ----------------------------------- |
| Rebut                           | Refus des immortels                                | +1 Déplacement <br/> +1 Endurance   |
| Citoyen                         | Fidélité aux immortels                             | +1 Technique <br/> +1 Discrétion    |
| Habitant des territoires libres | Originaire d'un territoire libre                   | +1 Savoir <br/> +1 Parole           |
| Célébrité                       | Star (oubliée ou non)                              | +1 Aura <br/> +1 Parole             |
| Survivant                       | A échappé au pire                                  | +1 Endurance <br/> +1 Hargne        |
| Membre d'une société secrète    | Black Cell, Fondation, Illuminati...               | +1 Savoir <br/> +1 Combat / Tir     |
| Agent du Nodachi                | Ex-membre du Nodachi                               | +1 Combat / Tir <br/> +1 Dextérité  |
| Membre d'un service secret      | CIA/DGSE/Organisation terroriste...                | +1 Combat / Tir <br/> +1 Discrétion |
| Génie                           | Pointure dans un sujet                             | +1 Savoir <br/> +1 Technique        |
| Artiste                         | Créateur passionné                                 | +1 Hargne <br/> +1 Aura             |
| Indépendant                     | Freelance                                          | +1 Perception <br/> +1 Instinct     |
| Religieux                       | Membre de culte                                    | +1 Sang-Froid <br/> +1 Hargne       |
| Leader                          | Chef (armée, maire...)                             | +1 Aura <br/> +1 Instinct           |
| Hors-la-loi                     | Trafiquant, mafieux en quête de rédemption         | +1 Sang-Froid <br/> +1 Discrétion   |
| Voyageur                        | Baroudeur, explorateur                             | +1 Déplacement <br/> +1 Perception  |
| Combattant                      | Homme d'action (militaire, soldat à son compte...) | +1 Combat <br/> +1 Tir              |
| Force de la nature              | Brute (bûcheron, haltérophile...)                  | +1 Force <br/> +1 Endurance         |
| Archétype libre                 | A vous de me dire !                                | A déterminer                        |
...
A 0 PA, l'armure se folde sauf réussite à un jet de *Technique*. Elle laisse place à la combinaison Guardian jusqu'à réparation par nod d'armure ou technicien.
